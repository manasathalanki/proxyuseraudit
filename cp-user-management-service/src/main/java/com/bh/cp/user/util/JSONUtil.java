...
public class JSONUtil {
	...
	private static String getDisplayName(String level, Map<String, Object> fields, String defaultValue) {
		...
		for (int i = 0; i < displayFields.length; i++) {
			...
			Matcher matcher = Pattern.compile("[a-zA-Z_]+").matcher(displayField);
	...
	static {
		...
		displayNames.put(JSONUtilConstants.LEVEL_PROJECTS, "project_cus_desc");
		displayNames.put(JSONUtilConstants.LEVEL_PLANTS, "plant_cus_desc");

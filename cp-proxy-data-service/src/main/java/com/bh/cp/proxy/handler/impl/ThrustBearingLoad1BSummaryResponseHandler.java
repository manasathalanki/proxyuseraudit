...
@Component
public class ThrustBearingLoad1BSummaryResponseHandler<T> extends JsonResponseHandler<T> {

	private ThrustBearingLoadSummaryResponseHandler thrustBearingLoadSummaryResponseHandler;

	@SuppressWarnings("unchecked")
	public ThrustBearingLoad1BSummaryResponseHandler(
	...
	protected Object parse(Map<String, Object> request) {
		...
		return thrustBearingLoadSummaryResponseHandler.parse(response, request, ProxyConstants.THRUST_1B);
	}
}

...
class FiredTokenCountResponseHandlerTest {
	private static class TestableFiredTokenCountResponseHandler extends FiredTokenCountResponseHandler<Map<String, Object>> {
		protected TestableFiredTokenCountResponseHandler(HttpServletRequest httpServletRequest) {
	...
	void testParse() throws Exception {
		TestableFiredTokenCountResponseHandler handler = new TestableFiredTokenCountResponseHandler(null);

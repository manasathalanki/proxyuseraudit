package com.bh.cp.user.exception.handler;
...
import com.bh.cp.user.constants.ExceptionConstants;
...
import com.bh.cp.user.test.exception.TestException;
...
class UserManagementExceptionHandlerTest {
	...
	class ServiceSpecificException {
		...
		private void assertNotFoundException(RestServiceErrorException output) {
			assertDoesNotThrow(() -> new JSONObject(output.getLocalizedMessage()));
		...
		private void assertBadRequestException(RestServiceErrorException output) {
			assertDoesNotThrow(() -> new JSONObject(output.getLocalizedMessage()));
			assertTrue(output.getLocalizedMessage().contains("\"detail\" : \"Test Message\""));
			assertTrue(output.getLocalizedMessage().contains("\"path\" : \"[GET] http://test.com\""));
			assertTrue(output.getLocalizedMessage().contains("\"httpStatusCode\" : \"400\""));
			assertTrue(output.getLocalizedMessage().contains("\"httpMethod\" : \"GET\""));
			assertEquals(HttpStatus.BAD_REQUEST, output.getHttpStatus());
		}
		...
		void testGetErrorMessageForExcptionType_Positive1() {
			...
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
			assertNotFoundException(output);
		}

		@Test
		@DisplayName("Test GetErrorMessageForExcptionType2 -- ServiceSpecific -- AttributeNotFoundException")
		void testGetErrorMessageForExcptionType_Positive2() {
			Exception exception = new AttributeNotFoundException("Test Message");
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
			assertNotFoundException(output);
		}
		...
		@Test
		@DisplayName("Test GetErrorMessageForExcptionType3 -- ServiceSpecific -- DeletionNotPermissableException")
		void testGetErrorMessageForExcptionType_Positive3() {
			Exception exception = new DeletionNotPermissableException("Test Message");
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
			assertBadRequestException(output);
		}

		@Test
		@DisplayName("Test GetErrorMessageForExcptionType4 -- ServiceSpecific -- RoleException")
		void testGetErrorMessageForExcptionType_Positive4() {
			Exception exception = new RoleException("Test Message");
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
			assertBadRequestException(output);
		}
		...
		@Test
		@DisplayName("Test GetErrorMessageForExcptionType5 -- ServiceSpecific -- SPARQUMSAPIErrorException")
		void testGetErrorMessageForExcptionType_Positive5() {
			Exception exception = new SPARQUMSAPIErrorException("Test Message", status);
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
		...
		@Test
		@DisplayName("Test GetErrorMessageForExcptionType6 -- ServiceSpecific -- UserNotCreatedException")
		void testGetErrorMessageForExcptionType_Positive6() {
			Exception exception = new UserNotCreatedException("Test Message");
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, HttpStatus.CONFLICT, exception);
			assertDoesNotThrow(() -> new JSONObject(output.getLocalizedMessage()));
			assertTrue(output.getLocalizedMessage().contains("\"detail\" : \"Test Message"));
			assertTrue(output.getLocalizedMessage().contains("\"path\" : \"[GET] http://test.com\""));
			assertTrue(output.getLocalizedMessage().contains("\"httpStatusCode\" : \"409\""));
			assertTrue(output.getLocalizedMessage().contains("\"httpMethod\" : \"GET\""));
			assertEquals(HttpStatus.CONFLICT, output.getHttpStatus());
		}

		@Test
		@DisplayName("Test GetErrorMessageForExcptionType7 -- ServiceSpecific -- Unhandled ServiceSpecific Exception")
	...
	void testHandleException_Positive1() {
		...
		ResponseEntity<Object> output = userManagementExceptionHandler.handleException(mockHttpServletRequest,
				exception);
	...
	void testHandleMethodArgumentNotValid_Positive1() {
		...
		ResponseEntity<Object> output = userManagementExceptionHandler.handleMethodArgumentNotValid(exception,
	...
	void testHandleErrorResponseException_Positive1() {
		...
		WebRequest request = new ServletWebRequest(mockHttpServletRequest);
		ResponseEntity<Object> output = userManagementExceptionHandler.handleErrorResponseException(exception,
				mock(HttpHeaders.class), status, request);
		assertTrue(output.getBody().toString()
	...
	class TestGetErrorMessageForExcptionType {
		...
		void testGetErrorMessageForExcptionType_Positive1() {
			...
			Exception exception = new ConversionNotSupportedException(userManagementExceptionHandler,
		...
		void testGetErrorMessageForExcptionType_Positive11() {
			Exception exception = new TypeMismatchException(new Object(), UserManagementExceptionHandler.class);
			RestServiceErrorException output = UserManagementExceptionHandler
					.getErrorMessageForExcptionType(mockHttpServletRequest, status, exception);
			assertInternalServerException(output,
					"\"detail\" : \"Failed to convert value of type 'java.lang.Object' to required type 'com.bh.cp.user.exception.handler.UserManagementExceptionHandler'\"");
		}

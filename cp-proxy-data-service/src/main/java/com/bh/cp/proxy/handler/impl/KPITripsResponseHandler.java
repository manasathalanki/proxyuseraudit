...
@Component
public class KPITripsResponseHandler<T> extends JsonResponseHandler<T> {

	private KPIStartsAndTripsResponseHandler kpiStartsAndTripsResponseHandler;

	@SuppressWarnings("unchecked")
	public KPITripsResponseHandler(@Autowired KPIStartsAndTripsResponseHandler kpiStartsAndTripsResponseHandler) {

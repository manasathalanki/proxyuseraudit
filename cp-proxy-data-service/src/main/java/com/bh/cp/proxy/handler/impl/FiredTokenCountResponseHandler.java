...
@Component
public class FiredTokenCountResponseHandler<T> extends JsonResponseHandler<T> {

	@Autowired
	@SuppressWarnings("unchecked")
	protected FiredTokenCountResponseHandler(HttpServletRequest httpServletRequest) {

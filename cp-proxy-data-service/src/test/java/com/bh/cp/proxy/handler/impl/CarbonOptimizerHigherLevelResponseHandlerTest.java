...
class CarbonOptimizerHigherLevelResponseHandlerTest {
	...
	@InjectMocks
	private CarbonOptimizerHigherLevelResponseHandler<?> handler;
	...
	void setUp() {
		...
		ReflectionTestUtils.setField(handler, "carbonOptimizerWidgetId", -21);
	...
	void testParseWithActualValueSuggestedValueNotNull() throws Exception {
		...
		assertEquals(false, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.RUNNING));
		assertEquals("9422.4kW", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.ACTUALVALUE));
		assertEquals("9433.4kW", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.SUGGESTEDVALUE));
		assertEquals(WidgetConstants.INCREEMENTREQUIRED, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.CARBONSTATUS));
		assertEquals("GT1462", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.UNIT));
		assertEquals(true, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(0).get(WidgetConstants.RUNNING));
		assertEquals("9929rpm", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(0).get(WidgetConstants.ACTUALVALUE));
		assertEquals("9924rpm", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(0).get(WidgetConstants.SUGGESTEDVALUE));
		assertEquals(WidgetConstants.DECREEMENTREQUIRED, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(0).get(WidgetConstants.CARBONSTATUS));
		assertEquals(6, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0).getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.RUNNINGIMAGEID));
	...
	void testParseWithEitherSuggestedValueOrActualValueNull() throws Exception {
		...
		assertEquals("9433.4kW", result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.SUGGESTEDVALUE));
		assertEquals(WidgetConstants.NOTAPPLICABLE, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.ACTUALVALUE));
		assertEquals(WidgetConstants.EMPTYSTRING, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.CARBONSTATUS));
		assertEquals(6, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.RUNNINGIMAGEID));
		assertEquals(false, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.RUNNING));
		assertEquals(WidgetConstants.EMPTYSTRING, result.getJSONArray(WidgetConstants.DATA).getJSONObject(0)
				.getJSONArray(WidgetConstants.MACHINES).getJSONObject(1).get(WidgetConstants.CHANGEREQUIRED));

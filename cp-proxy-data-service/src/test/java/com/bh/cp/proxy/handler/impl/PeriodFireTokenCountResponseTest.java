...
class PeriodFireTokenCountResponseTest {
	private static class TestablePeriodFireTokenCountResponseHandler extends PeriodFireTokenCountResponse<Map<String, Object>> {
		protected TestablePeriodFireTokenCountResponseHandler(HttpServletRequest httpServletRequest) {
	...
	void testParse() throws Exception {
		TestablePeriodFireTokenCountResponseHandler handler = new TestablePeriodFireTokenCountResponseHandler(null);

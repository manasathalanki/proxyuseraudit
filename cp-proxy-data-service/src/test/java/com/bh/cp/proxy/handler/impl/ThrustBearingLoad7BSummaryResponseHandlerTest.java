...
class ThrustBearingLoad7BSummaryResponseHandlerTest {

	@Mock
	private ThrustBearingLoadSummaryResponseHandler thrustBearingLoadSummaryResponseHandler;

	@InjectMocks
	private ThrustBearingLoad7BSummaryResponseHandler<?> handler;
	...
	void testParseWithNormal() {
		when(thrustBearingLoadSummaryResponseHandler.parse(mockResponseData, request, ProxyConstants.THRUST_7B)).thenReturn(new JSONObject(mockResponseData));

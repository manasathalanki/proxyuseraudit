...
import com.bh.cp.proxy.asset.service.CacheService;
...
public class CacheController {
	...
	@Operation(summary = "Clear Application cache", description = "Clears all caches of \"userassethierarchy\",\"proxyuserdetails\","
			+ "\"widgetaccess\",\"oktauserdetails\",\"alluserdetails\", \"userprivileges\", \"applicablemachines\",\"servicedirectory\"")
	@SecurityRequirement(name = "Keycloak Token")
	@CacheEvict(cacheNames = { "userassethierarchy", "proxyuserdetails", "widgetaccess", "oktauserdetails",
			"alluserdetails", "userprivileges", "applicablemachines", "servicedirectory" }, allEntries = true)

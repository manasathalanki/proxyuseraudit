...
@Component
public class LineUpFiredTokenCountResponse<T> extends JsonResponseHandler<T> {

	@Autowired
	@SuppressWarnings("unchecked")
	protected LineUpFiredTokenCountResponse(HttpServletRequest httpServletRequest) {

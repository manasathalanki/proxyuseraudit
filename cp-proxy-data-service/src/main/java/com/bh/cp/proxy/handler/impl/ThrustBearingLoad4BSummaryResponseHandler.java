...
@Component
public class ThrustBearingLoad4BSummaryResponseHandler<T> extends JsonResponseHandler<T> {

	private ThrustBearingLoadSummaryResponseHandler thrustBearingLoadSummaryResponseHandler;

	@SuppressWarnings("unchecked")
	public ThrustBearingLoad4BSummaryResponseHandler(
	...
	protected Object parse(Map<String, Object> request) {
		...
		return thrustBearingLoadSummaryResponseHandler.parse(response, request, ProxyConstants.THRUST_4B);
	}
}

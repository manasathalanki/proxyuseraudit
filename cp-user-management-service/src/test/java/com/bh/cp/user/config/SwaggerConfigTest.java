...
class SwaggerConfigTest {
	...
	void testMicroserviceOpenAPI_Positive1() {
		...
		assertEquals("CUSTOMER PORTAL - User Management Service API Documentation", output.getInfo().getDescription());
		assertEquals("CUSTOMER PORTAL USER MANAGEMENT SERVICE", output.getInfo().getTitle());
